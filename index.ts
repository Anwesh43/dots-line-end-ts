...
class DrawingUtil {
    ...
    static drawDTENode(context : CanvasRenderingContext2D, i : number, scale : number) {
...
class DTENode {
    ...
    addNeighbor() {
        if (this.i < colors.length - 1) {
            this.next = new DTENode(this.i + 1)
            this.next.prev = this 
        }
    }

    draw(context : CanvasRenderingContext2D) {
        DrawingUtil.drawDTENode(context, this.i, this.state.scale)
    }
